...
vg_words = [line.strip('\n').strip('\r') for line in open('/home/zhangjx/All_model/genration_scene/CaCao/CaCao_fork/CaCao/datasets/vg/predicate_list.txt')]
# total 587 categories for open-world VG
total_words = [line.strip('\n').strip('\r') for line in open('/home/zhangjx/All_model/genration_scene/CaCao/CaCao_fork/CaCao/datasets/vg/extra_predicates_list.txt')]
...
class fineTuningDataset(Dataset):
    def __init__(self, path, img_root,all_triplets,weight,predicates_words,mode=None):
        self.path = path
...
if __name__ == '__main__':
    dataset = fineTuningDataset('datasets/image_caption_triplet.json',"/media/data/lost+found/gff/datasheet/coco/train2014/",'train')
