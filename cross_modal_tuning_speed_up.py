...
from models.MLM.utils_speed_up import fineTuningDataset, load_vg_dataset_image_text,load_vg_mapping_dataset_image_text
...
if __name__ == '__main__':
    ...
    all_triplets, weight_1, predicates_words_1 = load_vg_mapping_dataset_image_text('datasets/image_caption_triplet_all.json')
    # all_triplets, weight_1, predicates_words_1 = load_vg_dataset_image_text('datasets/image_caption_triplet_all.json')
    train_dataset = fineTuningDataset('datasets/image_caption_triplet_all.json',"/home/Datasets/coco/train2014/",all_triplets,weight_1,predicates_words_1,'train')  ##权重
    val_dataset = fineTuningDataset('datasets/image_caption_triplet_all.json',"/home/Datasets/coco/train2014/",all_triplets,weight_1,predicates_words_1,'val')
    test_dataset = fineTuningDataset('datasets/image_caption_triplet_all.json',"/home/Datasets/coco/train2014/",all_triplets,weight_1,predicates_words_1,'test')
    ...
    words = train_dataset.predicates_words                         ##50个谓词
    relation_type_count = len(words)                               ##50
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=16)
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=True, num_workers=16)
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=True, num_workers=8)
    # train
